...
To get the current development version of **{rjd3toolkit}** from [GitHub](https://github.com/) with:
...
The code of this project is licensed under the [European Union Public Licence (EUPL)](https://interoperable-europe.ec.europa.eu/collection/eupl/eupl-text-eupl-12).
